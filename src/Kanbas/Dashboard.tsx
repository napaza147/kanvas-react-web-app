    ...
    <div id="wd-dashboard">
      ...
      <div className="d-flex">
        ...
        {currentUser.role === "STUDENT" && (
          <button className="btn btn-primary ms-auto" onClick={toggleEnrollment}>
            Enrollments
          </button>
        )}
      </div>
                  ...
                  <div>
                    ...
                    <div className="card-body">
                      ...
                      {!isEnrolled(course._id) && (
                        <button className="btn btn-success" onClick={() => addCurrEnrollment(course._id)}>
                          Enroll
                        </button>
                      )}
                      {isEnrolled(course._id) && (
                        <button className="btn btn-danger" onClick={() => removeCurrEnrollment(course._id)}>
                          Unenroll
                        </button>
                      )}
