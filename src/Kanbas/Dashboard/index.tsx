...
import { addEnrollment, deleteEnrollment, editEnrollment } from "../Courses/reducer";
    ...
    <div id="wd-dashboard">
      <div className="d-flex justify-content-between align-items-center">
        ...
        {currentUser.role === "STUDENT" && (
          ...
          {enrolling ? "View My Courses" : "View All Courses"}
        </button>
        )}
      </div>
          ...
          {courses.map((course: any) => (
            ...
            >
              <div className="card rounded-3 overflow-hidden">
                <img
                  src={`${process.env.REACT_APP_REMOTE_SERVER}${course.image}`}
                  width="100%"
                  height={160}
                  alt={course.name}
                />
