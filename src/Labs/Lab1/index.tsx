...
tag to tell browsers to render the gaps.
      ...
      <ol id="wd-your-favorite-recipe">
          <li>Add a whole pack of Ube pancake premix, from Trader Joes, to a bowl.</li>
          <li>Add 100 grams of Ube butter and an egg yolk.</li>
          <li>Combine it, put it on a muffin tray and bake it as if it were muffins at 400F for 30 minutes.</li>
    ...
    <div id="wd-images">
      ...
      <a id="wd-github" href="https://github.com/napaza147/kanvas-react-web-app"> click here </a>
